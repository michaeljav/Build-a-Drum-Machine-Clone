...
const Drumpkey = (props) => {
  ...
  const [padStyleState,setPadStyleState] = useState(inactiveStyle); 
  ...
  // React.useEffect(() => {
  //   const id =setTimeout(() => {
  //     console.log("EXECUTING  SET TIMEOUT  USEEFFECT ");
...
const activeDrumpkey = (padStyleStateVariable) =>  {
  console.log('Entered activeDrumpkey');
  console.log('padStyleState.backgroundColor' );
  console.log(padStyleStateVariable.backgroundColor );
 if (padStyleStateVariable.backgroundColor === 'orange') {
   console.log('Entered Orange');
   setPadStyleState((inactiveStyle) => inactiveStyle);
  //  console.warn(inactiveStyle);
 }else {
   console.log('NOT Entered Orange');
    // setPadStyleState({...activeStyle}); 
    setPadStyleState((activeStyle) => activeStyle);
    console.log('Value state:');  
    console.log(padStyleStateVariable);
 }
}
const playSound = () => {
